...
const MODELS = [
  // ── OpenAI ─────────────────────────────────────────────
  {
    ...
    bestFor: [
      ...
      "Long-form writing & storytelling",
  ...
  // ── Anthropic ──────────────────────────────────────────
  {
    ...
    bestFor: [
      ...
      "NFT lore & character writing",
      "Nuanced instruction following",
      "Safe & ethical AI outputs",
  ...
  // ── xAI Grok ───────────────────────────────────────────
  {
    ...
    bestFor: [
      "Crypto market deep-dives",
      "DeFi trading insights",
      "Advanced financial modeling",
      "On-chain data reasoning",
  ...
  // ── Meta / Open Source ─────────────────────────────────
  {
    ...
    bestFor: [
      ...
      "Open-source AI builds",
      "Agentic multi-step reasoning",
      "Verifiable AI (TEE/ZKML)",
    ],
  ...
  // ── OpenGradient OG Crypto Models ──────────────────────
  {
    ...
    bestFor: [
      "BTC/USDT 1H price signals",
      "Automated BTC trading bots",
      "BitQuant agent integration",
      "On-chain quant strategies",
      "DeFi BTC position sizing",
    ],
  ...
  },
  {
    ...
    bestFor: [
      "ETH/USDT volatility forecasting",
      "Options & derivatives strategies",
      "AMM fee optimization",
      "Risk-adjusted ETH positions",
  ...
  },
  {
    ...
    bestFor: [
      "SOL/USDT 1H spot price signals",
      "Solana automated trading bots",
      "On-chain Solana quant strategies",
      "DeFi SOL position management",
  ...
  },
  {
    ...
    bestFor: [
      "SUI/USDT 30-minute price forecasting",
      "Short-term SUI trading",
      "High-frequency SUI strategies",
      "On-chain SUI DeFi automation",
      "Liquidity management on SUI",
    ],
  ...
  },
  {
    ...
    bestFor: [
      "SUI/USDT 6-hour trend analysis",
      "Swing trading on SUI",
      "DeFi yield strategy planning",
      "On-chain SUI portfolio management",
      "Medium-term SUI positioning",
    ],
        ...
        <div style={{ display: "flex", gap: 12, alignItems: "flex-start", flex: 1, minWidth: 0 }}>
          ...
          <div style={{ minWidth: 0 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap", marginBottom: 2 }}>
              <span style={{ fontFamily: "'Syne', sans-serif", fontWeight: 700, fontSize: 15, color: model.color }}>
                {model.name}
              </span>
              <span
                style={{
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
              {model.bestFor.map((b) => (
                <div key={b} style={{ display: "flex", alignItems: "center", gap: 8 }}>
                  ...
                  <span style={{ fontSize: 13, color: "rgba(255,255,255,0.72)", fontFamily: "'Syne', sans-serif" }}>
                    {b}
                  </span>
                </div>
              ))}
              ...
              <div key={s.label}>
                ...
                <div style={{ display: "flex", gap: 3 }}>
                  {Array.from({ length: 5 }).map((_, i) => (
                    <Pip key={i} filled={i < Math.ceil(s.val / 2)} color={s.color} />
                  ))}
                </div>
              </div>
            ))}
    ...
    <div style={{ minHeight: "100vh", background: "#04060c", color: "white", fontFamily: "'Syne', sans-serif" }}>
      ...
      <div
        style={{
          ...
          zIndex: 0,
          pointerEvents: "none",
          background: "radial-gradient(ellipse 90% 40% at 50% 0%, rgba(99,102,241,0.1), transparent)",
        }}
      />
      ...
      <div style={{ position: "relative", zIndex: 1, maxWidth: 1100, margin: "0 auto", padding: "52px 20px 80px" }}>
        <div style={{ textAlign: "center", marginBottom: 48, animation: "fadein 0.5s ease" }}>
          ...
          >
            ...
            />
            <span style={{ fontSize: 10, letterSpacing: 3, color: "#818cf8", fontFamily: "monospace" }}>
              OPENGRADIENT · VERIFIED AI HUB
            </span>
          </div>
          ...
          >
            ...
            <span
              style={{
                background: "linear-gradient(120deg, #6366f1, #06b6d4, #10b981)",
                WebkitBackgroundClip: "text",
                WebkitTextFillColor: "transparent",
              }}
            >
              One Decentralized Hub.
            </span>
          </h1>
        ...
        {groups.length === 0 ? (
          <div style={{ textAlign: "center", padding: 60, color: "rgba(255,255,255,0.2)", fontFamily: "monospace" }}>
        ...
        >
          ...
          <a
            href="https://hub.opengradient.ai/models"
            target="_blank"
            rel="noopener noreferrer"
            style={{
              display: "inline-block",
